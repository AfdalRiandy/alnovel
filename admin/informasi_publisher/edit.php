...
<head>
    ...
    <title>Admin Section - Edit Publisher</title>
</head>
            ...
            <div class="content">
                ...
                <form action="edit.php" method="post">
                    ...
                    <div>
                        ...
                        <?php $informasi_novel_id = isset($_POST['informasi_novel_id']) ? $_POST['informasi_novel_id'] : ''; ?>
                        <select name="judulnovel_id" class="text-input">
                            ...
                            <option selected value="<?php echo $informasi_novel['id']; ?>">
                                <?php echo $informasi_novel['Judul_Novel']; ?></option>
                            <?php else: ?>
                    ...
                    <div>
                        <button type="submit" name="update-publisher" class="btn btn-big">Update publisher</button>
                    </div>
                </form>
